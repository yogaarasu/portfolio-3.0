      ...
      <div className="order-first md:order-last">
        ...
        <div className="relative mx-auto px-8 sm:px-12 md:px-0">
          <div className="relative mx-auto h-64 w-64 sm:h-80 sm:w-80">
            ...
            <FaReact size={56} className={`floating-icon pointer-events-none absolute -left-8 -top-4 sm:-left-16 sm:-top-6 text-[#61DAFB] drop-shadow-2xl animate-float-smooth-slow z-20 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '0s', filter: 'drop-shadow(0 0 15px rgba(97, 218, 251, 0.6))' }} />
            <FaNodeJs size={40} className={`floating-icon pointer-events-none absolute left-10 -top-36 sm:left-12 sm:top-40 text-[#339933] drop-shadow-2xl animate-float-smooth-slow z-0 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-90'}`} style={{ animationDelay: '0.8s', filter: 'drop-shadow(0 0 10px rgba(51, 153, 51, 0.5))' }} />
            <FaHtml5 size={44} className={`floating-icon pointer-events-none absolute -right-8 bottom-20 sm:-right-14 sm:bottom-24 text-[#E34F26] drop-shadow-2xl animate-float-smooth-slow z-20 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '1.6s', filter: 'drop-shadow(0 0 12px rgba(227, 79, 38, 0.5))' }} />
            <FaCss3Alt size={36} className={`floating-icon pointer-events-none absolute right-8 bottom-8 sm:right-10 sm:bottom-10 text-[#1572B6] drop-shadow-2xl animate-float-smooth-slow z-0 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-90'}`} style={{ animationDelay: '2.4s', filter: 'drop-shadow(0 0 8px rgba(21, 114, 182, 0.4))' }} />
            <SiTypescript size={42} className={`floating-icon pointer-events-none absolute -right-8 top-12 sm:-right-12 sm:top-14 text-[#3178C6] drop-shadow-2xl animate-float-smooth-slow z-20 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '1.2s', filter: 'drop-shadow(0 0 10px rgba(49, 120, 198, 0.5))' }} />
            <SiMongodb size={38} className={`floating-icon pointer-events-none absolute -left-4 bottom-0 sm:-left-12 sm:-bottom-6 text-[#47A248] drop-shadow-2xl animate-float-smooth-slow z-0 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-90'}`} style={{ animationDelay: '2.0s', filter: 'drop-shadow(0 0 8px rgba(71, 162, 72, 0.4))' }} />
            <SiJavascript size={40} className={`floating-icon pointer-events-none absolute -left-8 top-[45%] -translate-y-1/2 sm:-left-16 sm:top-1/2 text-[#F7DF1E] drop-shadow-2xl animate-float-smooth-slow z-20 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '0.4s', filter: 'drop-shadow(0 0 10px rgba(247, 223, 30, 0.6))' }} />
            <SiExpress size={36} className={`floating-icon pointer-events-none absolute left-1/2 -translate-x-1/2 -top-10 sm:-top-14 text-white drop-shadow-2xl animate-float-smooth-slow z-20 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '3.2s', filter: 'drop-shadow(0 0 8px rgba(255, 255, 255, 0.4))' }} />
            <SiGit size={40} className={`floating-icon pointer-events-none absolute left-1/2 -translate-x-1/2 -bottom-10 sm:-bottom-14 text-[#F05032] drop-shadow-2xl animate-float-smooth-slow z-0 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-90'}`} style={{ animationDelay: '3.6s', filter: 'drop-shadow(0 0 10px rgba(240, 80, 50, 0.5))' }} />
          </div>
        </div>
      </div>
    </div>
