      ...
      <div className="order-first md:order-last">
        ...
        <div className="relative mx-auto px-8 sm:px-12 md:px-0">
          <div className="relative mx-auto h-64 w-64 sm:h-80 sm:w-80">
            ...
            <FaReact size={56} className={`floating-icon pointer-events-none absolute -left-8 -top-4 sm:-left-16 sm:-top-6 text-[#61DAFB] drop-shadow-2xl animate-float-smooth-slow z-0 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '0s', filter: 'drop-shadow(0 0 15px rgba(97, 218, 251, 0.6))' }} />
            ...
            <FaHtml5 size={44} className={`floating-icon pointer-events-none absolute -right-8 bottom-20 sm:-right-14 sm:bottom-24 text-[#E34F26] drop-shadow-2xl animate-float-smooth-slow z-0 transition-opacity duration-300 ${isScrolled ? 'opacity-100' : 'opacity-100'}`} style={{ animationDelay: '1.6s', filter: 'drop-shadow(0 0 12px rgba(227, 79, 38, 0.5))' }} />
